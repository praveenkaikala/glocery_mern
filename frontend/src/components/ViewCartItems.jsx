...
import imageEmpty from '../assets/nodata.webp'

const ViewCartItems = ({close}) => {
        ...
        <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
            ...
            <div className='min-h-[75vh] lg:min-h-[80vh] h-full max-h-[calc(100vh-150px)] bg-blue-50 p-2 flex flex-col gap-4'>
                {/***display items */}
                {
                    cartItem[0] ? (
                        <>
                            <div className='flex items-center justify-between px-4 py-1 bg-blue-100 text-blue-500 rounded-full'>
                                                ...
                                                return(
                                                    <div key={item?._id+"cartItemDisplay"} className='flex  w-full gap-4'>
                                                        ...
                                                        <div className='w-full max-w-sm text-xs'>
                                                            ...
                                                            <p className='text-neutral-400'>{item?.product_id?.unit}</p>
                                                            <p className='font-semibold'>{DisplayPriceInRupees(pricewithDiscount(item?.product_id?.price,item?.product_id?.discount))}</p>
                                                        </div>
                                                        <div>
