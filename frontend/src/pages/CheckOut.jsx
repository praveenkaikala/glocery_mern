    ...
    <section className="bg-blue-50">
      <div className="container mx-auto p-4 flex flex-col lg:flex-row w-full gap-5 justify-between">
        <div className="w-full">
          ...
          <div className="bg-white p-2 grid gap-4 h-[65vh] overflow-x-scroll">
          ...
          <div
            ...
            className="h-14 bg-blue-50 border-2 border-dashed flex justify-center items-center cursor-pointer"
          >
            Add address
          </div>
        </div>
